...
export default function Tickets() {
  ...
  const carregarTickets = async () => {
    setLoading(true);
    try {
      const dados = await ticketService.listarPorUsuarioCriador(user!.id);
      setTickets(dados);
    } catch (error: any) {
...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 22, fontWeight: "700", color: "#0f172a", textAlign: "center", marginRight: 40, marginTop: 18 },
  ...
  listContent: { padding: 16, paddingBottom: 150, gap: 12 },
  ...
  fab: { position: "absolute", bottom: 130, right: 20, width: 56, height: 56, borderRadius: 28, backgroundColor: "#2563eb", alignItems: "center", justifyContent: "center", elevation: 6 },
});